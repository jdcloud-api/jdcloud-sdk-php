...
class TraceMiddleware
{
    ...
    private static $authStrings = [
        // S3Signature
        '/AccessKeyId=[A-Z0-9]{20}&/i' => 'AccessKeyId=[KEY]&',
        ...
        // STS Presigned URLs
        '/x-jdcloud-security-token=[^&]+/i' => 'x-jdcloud-security-token=[TOKEN]',
    ];
    ...
    private function exceptionArray($e)
    {
        ...
        if ($e instanceof JdcloudException) {
            $result += [
                'type'       => $e->getJdcloudErrorType(),
                'code'       => $e->getJdcloudErrorCode(),
                'requestId'  => $e->getJdcloudRequestId(),

    ...
    'shapes' => [
        ...
        'BackSourceHeaderRule' => [
            ...
            'members' => [
                ...
                'setHeaders' => [ 'type' => 'map', 'key' => [ 'shape' => 'string', ], 'value' => [ 'shape' => 'string', ], ],
            ],
        ],
        ...
        'SignatureInfo' => [
            ...
            'members' => [
                ...
                'additionalSignatureHeaders' => [ 'type' => 'map', 'key' => [ 'shape' => 'string', ], 'value' => [ 'shape' => 'string', ], ],
                'signatureParameters' => [ 'type' => 'map', 'key' => [ 'shape' => 'string', ], 'value' => [ 'shape' => 'string', ], ],
            ],
        ],
        'SignatureResult' => [
            'type' => 'structure',

    ...
    'shapes' => [
        ...
        'NoticeLevel' => [
            ...
            'members' => [
                ...
                'levels' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'double', ], ],
            ],
        ],
        'AlertChannel' => [
            'type' => 'structure',
        ...
        'Annotation' => [
            'type' => 'structure',
            'members' => [
                'custom' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'string', ], ],
        ...
        'BasicDatasource' => [
            'type' => 'structure',
            'members' => [
                'customHttpHeader' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'string', ], ],
        ...
        'WidgetRawResource' => [
            ...
            'members' => [
                ...
                'resourceId' => [ 'type' => 'string', 'locationName' => 'resourceId', ],
                'tag' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'string', ], ],
            ],
        ],
        'WidgetTagResource' => [
            'type' => 'structure',
        ...
        'DescribeAlarmHistoryDetail' => [
            ...
            'members' => [
                ...
                'dimension' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'string', ], ],
        ...
        'MetricDataCm' => [
            ...
            'members' => [
                'namespace' => [ 'type' => 'string', 'locationName' => 'namespace', ],
                'metric' => [ 'type' => 'string', 'locationName' => 'metric', ],
                'dimensions' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'string', ], ],
                'timestamp' => [ 'type' => 'long', 'locationName' => 'timestamp', ],
                'type' => [ 'type' => 'integer', 'locationName' => 'type', ],
                'values' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'string', ], ],
                'unit' => [ 'type' => 'string', 'locationName' => 'unit', ],
            ],
        ],
        'MetricDataItemCm' => [
        ...
        'PanelDimension' => [
            'type' => 'structure',
            'members' => [
                'bindTags' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'string', ], ],
                'dimension' => [ 'type' => 'string', 'locationName' => 'dimension', ],
                'dimensionName' => [ 'type' => 'string', 'locationName' => 'dimensionName', ],
        ...
        'QueryResponseItem' => [
            ...
            'members' => [
                ...
                'dps' => [ 'type' => 'map', 'key' => [ 'type' => 'string', ], 'value' => [ 'type' => 'string', ], ],

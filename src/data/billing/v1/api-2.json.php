...
//        'serviceId' => 'billing',
    ...
    'operations' => [
        ...
        'QuerySplitItemDaySummary' => [
            'name' => 'QuerySplitItemDaySummary',
            'http' => [
                'method' => 'POST',
                'requestUri' => '/v1/regions/{regionId}/splitItemBillDaySummary:List',
            ],
            'input' => [ 'shape' => 'QuerySplitItemDaySummaryRequestShape', ],
            'output' => [ 'shape' => 'QuerySplitItemDaySummaryResponseShape', ],
        ],
        'QuerySplitItemMonthSummary' => [
            'name' => 'QuerySplitItemMonthSummary',
            'http' => [
                'method' => 'POST',
                'requestUri' => '/v1/regions/{regionId}/splitItemBillMonthSummary:List',
            ],
            'input' => [ 'shape' => 'QuerySplitItemMonthSummaryRequestShape', ],
            'output' => [ 'shape' => 'QuerySplitItemMonthSummaryResponseShape', ],
        ],
        'QueryBillDaySummary' => [
            'name' => 'QueryBillDaySummary',
            'http' => [
                'method' => 'POST',
                'requestUri' => '/v1/regions/{regionId}/billDaySummary:list',
            ],
            'input' => [ 'shape' => 'QueryBillDaySummaryRequestShape', ],
            'output' => [ 'shape' => 'QueryBillDaySummaryResponseShape', ],
        ],
        'CalculateTotalPrice' => [
    ...
    'shapes' => [
        ...
        'RenewlResourceSearchExpireDateVo' => [
            ...
            'members' => [
                'expireInDays' => [ 'type' => 'integer', 'locationName' => 'expireInDays', ],
                'expireName' => [ 'type' => 'string', 'locationName' => 'expireName', ],
                'count' => [ 'type' => 'integer', 'locationName' => 'count', ],
            ],
        ],
        ...
        'ResourceOrderRenewNewQueryCondition' => [
            'type' => 'structure',
            'members' => [
                'id' => [ 'type' => 'integer', 'locationName' => 'id', ],
                'pin' => [ 'type' => 'string', 'locationName' => 'pin', ],
                ...
                'pageSize' => [ 'type' => 'integer', 'locationName' => 'pageSize', ],
                'offset' => [ 'type' => 'integer', 'locationName' => 'offset', ],
                'renewType' => [ 'type' => 'string', 'locationName' => 'renewType', ],
                'resourceName' => [ 'type' => 'string', 'locationName' => 'resourceName', ],
                'tagFilters' => [ 'type' => 'list', 'member' => [ 'shape' => 'TagFilter', ], ],
            ],
        ],
        'ResourceOrderRenewNewVo' => [
            'type' => 'structure',
            'members' => [
                'id' => [ 'type' => 'integer', 'locationName' => 'id', ],
                'transactionNo' => [ 'type' => 'string', 'locationName' => 'transactionNo', ],
                ...
                'tag' => [ 'type' => 'list', 'member' => [ 'shape' => 'ResourceTagVo', ], ],
                'bindResources' => [ 'type' => 'list', 'member' => [ 'shape' => 'ResourceOrderRenewNewVo', ], ],
            ],
        ],
        ...
        'SplitItemBillSummary' => [
            ...
            'members' => [
                ...
                'formulaInfo' => [ 'type' => 'string', 'locationName' => 'formulaInfo', ],
                'usageInfo' => [ 'type' => 'string', 'locationName' => 'usageInfo', ],
                'unitPriceInfo' => [ 'type' => 'string', 'locationName' => 'unitPriceInfo', ],
                'deductUsageInfo' => [ 'type' => 'string', 'locationName' => 'deductUsageInfo', ],
                'billFee' => [ 'type' => 'double', 'locationName' => 'billFee', ],
                'actualFee' => [ 'type' => 'double', 'locationName' => 'actualFee', ],
                'tagDetails' => [ 'type' => 'list', 'member' => [ 'shape' => 'ResourceTagVo', ], ],
            ],
        ...
        'UnreleasedSc' => [
            'type' => 'structure',
            'members' => [
                'accessType' => [ 'type' => 'integer', 'locationName' => 'accessType', ],
                'serviceCode' => [ 'type' => 'string', 'locationName' => 'serviceCode', ],
                'serviceCodeName' => [ 'type' => 'string', 'locationName' => 'serviceCodeName', ],
                'desc' => [ 'type' => 'string', 'locationName' => 'desc', ],
                'scUrl' => [ 'type' => 'string', 'locationName' => 'scUrl', ],
                'resourceCount' => [ 'type' => 'string', 'locationName' => 'resourceCount', ],
            ],
        ],
        ...
        'QueryBillDaySummaryResponseShape' => [
            'type' => 'structure',
            'members' => [
                'result' =>  [ 'shape' => 'QueryBillDaySummaryResultShape', ],
                'requestId' => [ 'type' => 'string', 'locationName' => 'requestId', ],
            ],
        ],
        'QueryBillDaySummaryRequestShape' => [
            'type' => 'structure',
            'members' => [
                'startTime' => [ 'type' => 'string', 'locationName' => 'startTime', ],
                'endTime' => [ 'type' => 'string', 'locationName' => 'endTime', ],
        ...
        'QuerySplitItemDaySummaryResponseShape' => [
            'type' => 'structure',
            'members' => [
                'result' =>  [ 'shape' => 'QuerySplitItemDaySummaryResultShape', ],
                'requestId' => [ 'type' => 'string', 'locationName' => 'requestId', ],
            ],
        ],
        'QuerySplitItemMonthSummaryResultShape' => [
            'type' => 'structure',
            'members' => [
                'pagination' =>  [ 'shape' => 'Pagination', ],
                'result' => [ 'type' => 'list', 'member' => [ 'shape' => 'SplitItemBillSummary', ], ],
            ],
        ],
        ...
        'QuerySplitItemDaySummaryResultShape' => [
            'type' => 'structure',
            'members' => [
                'pagination' =>  [ 'shape' => 'Pagination', ],
                'result' => [ 'type' => 'list', 'member' => [ 'shape' => 'SplitItemBillSummary', ], ],
        ...
        'QuerySplitItemMonthSummaryResponseShape' => [
            'type' => 'structure',
            'members' => [
                'result' =>  [ 'shape' => 'QuerySplitItemMonthSummaryResultShape', ],
                'requestId' => [ 'type' => 'string', 'locationName' => 'requestId', ],
            ],
        ],
        'QueryBillDaySummaryResultShape' => [
            'type' => 'structure',
            'members' => [
                'pagination' =>  [ 'shape' => 'Pagination', ],
        ...
        'QuerySplitItemMonthSummaryRequestShape' => [
            'type' => 'structure',
            'members' => [
                'startTime' => [ 'type' => 'string', 'locationName' => 'startTime', ],
                'endTime' => [ 'type' => 'string', 'locationName' => 'endTime', ],
        ...
        'QuerySplitItemDaySummaryRequestShape' => [
            'type' => 'structure',
            'members' => [
                'startTime' => [ 'type' => 'string', 'locationName' => 'startTime', ],
                'endTime' => [ 'type' => 'string', 'locationName' => 'endTime', ],

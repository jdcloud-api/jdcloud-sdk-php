 ...
 * @method \Jdcloud\Result describeNatIpCidrs(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeNatIpCidrsAsync(array $args = [])
 * @method \Jdcloud\Result addNatIpCidr(array $args = [])
 * @method \GuzzleHttp\Promise\Promise addNatIpCidrAsync(array $args = [])
 * @method \Jdcloud\Result modifyNatIpCidr(array $args = [])
 * @method \GuzzleHttp\Promise\Promise modifyNatIpCidrAsync(array $args = [])
 * @method \Jdcloud\Result removeNatIpCidr(array $args = [])
 * @method \GuzzleHttp\Promise\Promise removeNatIpCidrAsync(array $args = [])
 * @method \Jdcloud\Result describeNatIps(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeNatIpsAsync(array $args = [])
 * @method \Jdcloud\Result allocateNatIp(array $args = [])
 * @method \GuzzleHttp\Promise\Promise allocateNatIpAsync(array $args = [])
 * @method \Jdcloud\Result modifyNatIp(array $args = [])
 * @method \GuzzleHttp\Promise\Promise modifyNatIpAsync(array $args = [])
 * @method \Jdcloud\Result releaseNatIps(array $args = [])
 * @method \GuzzleHttp\Promise\Promise releaseNatIpsAsync(array $args = [])

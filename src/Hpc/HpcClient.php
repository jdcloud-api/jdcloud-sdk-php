 ...
 * @method \Jdcloud\Result deleteDiagnosticTask(array $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteDiagnosticTaskAsync(array $args = [])
 * @method \Jdcloud\Result deleteHpcNetDiagnose(array $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteHpcNetDiagnoseAsync(array $args = [])
 * @method \Jdcloud\Result describeHpcNetDiagnoses(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeHpcNetDiagnosesAsync(array $args = [])
 * @method \Jdcloud\Result createHpcNetDiagnose(array $args = [])
 * @method \GuzzleHttp\Promise\Promise createHpcNetDiagnoseAsync(array $args = [])

 ...
 * @method \Jdcloud\Result queryResponseSpeedLimit(array $args = [])
 * @method \GuzzleHttp\Promise\Promise queryResponseSpeedLimitAsync(array $args = [])
 * @method \Jdcloud\Result createResponseSpeedLimit(array $args = [])
 * @method \GuzzleHttp\Promise\Promise createResponseSpeedLimitAsync(array $args = [])
 * @method \Jdcloud\Result updateResponseSpeedLimit(array $args = [])
 * @method \GuzzleHttp\Promise\Promise updateResponseSpeedLimitAsync(array $args = [])
 * @method \Jdcloud\Result deleteResponseSpeedLimit(array $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteResponseSpeedLimitAsync(array $args = [])
 * @method \Jdcloud\Result queryDynamicGzip(array $args = [])
 * @method \GuzzleHttp\Promise\Promise queryDynamicGzipAsync(array $args = [])
 * @method \Jdcloud\Result configDynamicGzip(array $args = [])
 * @method \GuzzleHttp\Promise\Promise configDynamicGzipAsync(array $args = [])
 * @method \Jdcloud\Result queryDynamicBrotli(array $args = [])
 * @method \GuzzleHttp\Promise\Promise queryDynamicBrotliAsync(array $args = [])
 * @method \Jdcloud\Result configDynamicBrotli(array $args = [])
 * @method \GuzzleHttp\Promise\Promise configDynamicBrotliAsync(array $args = [])
 ...
 * @method \Jdcloud\Result setLiveDomainRtc(array $args = [])
 * @method \GuzzleHttp\Promise\Promise setLiveDomainRtcAsync(array $args = [])

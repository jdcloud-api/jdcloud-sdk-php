 ...
 * @method \Jdcloud\Result operateLiveDomainIgnoreQueryString(array $args = [])
 * @method \GuzzleHttp\Promise\Promise operateLiveDomainIgnoreQueryStringAsync(array $args = [])
 * @method \Jdcloud\Result setPushIpWhiteList(array $args = [])
 * @method \GuzzleHttp\Promise\Promise setPushIpWhiteListAsync(array $args = [])
 * @method \Jdcloud\Result setPublishNormalTimeout(array $args = [])
 * @method \GuzzleHttp\Promise\Promise setPublishNormalTimeoutAsync(array $args = [])
 * @method \Jdcloud\Result setStreamNotifyInfo(array $args = [])
 * @method \GuzzleHttp\Promise\Promise setStreamNotifyInfoAsync(array $args = [])
 * @method \Jdcloud\Result setForwardAuthentication(array $args = [])
 * @method \GuzzleHttp\Promise\Promise setForwardAuthenticationAsync(array $args = [])
 * @method \Jdcloud\Result setOriginAuthentication(array $args = [])
 * @method \GuzzleHttp\Promise\Promise setOriginAuthenticationAsync(array $args = [])
 ...
 * @method \Jdcloud\Result bindPublishDomain(array $args = [])
 * @method \GuzzleHttp\Promise\Promise bindPublishDomainAsync(array $args = [])
 * @method \Jdcloud\Result modifyLiveDomainForwardCustomVhost(array $args = [])
 * @method \GuzzleHttp\Promise\Promise modifyLiveDomainForwardCustomVhostAsync(array $args = [])
 ...
 * @method \Jdcloud\Result queryLiveDomainDetailV2(array $args = [])
 * @method \GuzzleHttp\Promise\Promise queryLiveDomainDetailV2Async(array $args = [])
 * @method \Jdcloud\Result describePublishDomains(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describePublishDomainsAsync(array $args = [])
 * @method \Jdcloud\Result describebindedDomains(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describebindedDomainsAsync(array $args = [])

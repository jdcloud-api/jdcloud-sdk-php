...
/**
 * Represents an Jdcloud client.
 */
interface JdCloudClientInterface
{
    /**
     ...
     * {@see \Jdcloud\Credentials\CredentialsInterface} object.
     *
     ...
     *
     * @return \Jdcloud\ResultPaginator
     * @throws \UnexpectedValueException if the iterator config is invalid.
     */

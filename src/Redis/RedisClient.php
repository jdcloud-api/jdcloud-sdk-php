 ...
 * @method \Jdcloud\Result describeConfigCenterTokenAndCipher(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeConfigCenterTokenAndCipherAsync(array $args = [])
 * @method \Jdcloud\Result describeClientSumUseR2MJavaClient(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeClientSumUseR2MJavaClientAsync(array $args = [])
 * @method \Jdcloud\Result describeClientDetailUseR2MJavaClient(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeClientDetailUseR2MJavaClientAsync(array $args = [])
 * @method \Jdcloud\Result describeClientPerfData(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeClientPerfDataAsync(array $args = [])
 * @method \Jdcloud\Result filteredClientPerfData(array $args = [])
 * @method \GuzzleHttp\Promise\Promise filteredClientPerfDataAsync(array $args = [])
 * @method \Jdcloud\Result describeNodeList(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeNodeListAsync(array $args = [])

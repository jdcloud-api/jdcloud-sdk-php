 ...
 * Jdcloud\ResultInterface and Jdcloud\Exception\JdcloudException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see Jdcloud\ResultInterface} or
     * {@see JdcloudException} objects that acts as a queue of results or
    ...
    /**
     * Adds one or more variadic ResultInterface or JdcloudException objects to the
     * queue.
     */
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                || $value instanceof JdcloudException
                || is_callable($value)
            ) {
                $this->queue[] = $value;
            } else {
                throw new \InvalidArgumentException('Expected an Jdcloud\ResultInterface or Jdcloud\Exception\JdcloudException.');
            }
        }
    }

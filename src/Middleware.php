...
//         };
     ...
     *
     * @param callable $f Map function that accepts an Jdcloud\ResultInterface and
     *                    returns an Jdcloud\ResultInterface.
     *
     * @return callable
     */
                ...
                return $handler($command, $request)
                    ->then(
                        ...
                        function ($err) use ($start) {
                            if ($err instanceof JdcloudException) {
                                $err->setTransferInfo([

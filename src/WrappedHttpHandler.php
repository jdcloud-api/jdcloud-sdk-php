...
class WrappedHttpHandler
{
    ...
    public function __construct(
        ...
        $exceptionClass = 'Jdcloud\Exception\JdcloudException',
        $collectStats = false
    ) {
     ...
     * with Jdcloud specific values (e.g., a result object or Jdcloud exception).
     *
    ...
    public function __invoke(
        ...
        if ($this->collectStats) {
            ...
            throw new \InvalidArgumentException('Providing a custom HTTP stats'
                . ' receiver to Jdcloud\WrappedHttpHandler is not supported.');
        }
...
//         $result['@metadata'] = $metadata;
    ...
    /**
     * Parses a rejection into an Jdcloud error.
     *
    ...
    private function parseError(
        ...
        $serviceError = "Jdcloud HTTP error: " . $err['exception']->getMessage();

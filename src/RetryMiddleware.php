...
class RetryMiddleware
{
    ...
    /**
     * Creates a default Jdcloud retry decider function.
     *
    ...
    public static function createDefaultDecider($maxRetries = 3)
    {
        ...
        return function (
            ...
            if (!($error instanceof JdcloudException)) {
                return false;
            }
            ...
            if (isset(self::$retryCodes[$error->getJdcloudErrorCode()])) {
                return true;
            }
    ...
    {
        return $request->withHeader('jdcloud-sdk-retry', "{$retries}/{$delayBy}");
    }
    ...
    private function updateHttpStats($value, array &$stats)
    {
        ...
        if ($value instanceof JdcloudException) {
    ...
    private function bindStatsToReturn($return, array $stats)
    {
        ...
        } elseif ($return instanceof JdcloudException) {

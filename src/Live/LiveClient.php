 ...
 * @method \Jdcloud\Result describeLiveRecordFiles(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeLiveRecordFilesAsync(array $args = [])
 * @method \Jdcloud\Result deleteLiveRecordFiles(array $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteLiveRecordFilesAsync(array $args = [])
 * @method \Jdcloud\Result describeLiveRecordFileUrl(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeLiveRecordFileUrlAsync(array $args = [])
 ...
 * @method \Jdcloud\Result describeLiveSnapshots(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeLiveSnapshotsAsync(array $args = [])
 * @method \Jdcloud\Result deleteLiveSnapshots(array $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteLiveSnapshotsAsync(array $args = [])
 * @method \Jdcloud\Result describeLiveSnapshotUrl(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeLiveSnapshotUrlAsync(array $args = [])
 ...
 * @method \Jdcloud\Result updateCustomLiveStreamWatermarkTemplate(array $args = [])
 * @method \GuzzleHttp\Promise\Promise updateCustomLiveStreamWatermarkTemplateAsync(array $args = [])
